...
test('normalizza IPv4, IPv4-mapped IPv6 e zone identifier', () => {
...
test('classifica indirizzi privati, riservati, pubblici e non validi', () => {
...
test('valida finestra attività e porta con fallback', () => {
...
test('normalizza timestamp Unix e date testuali', () => {
...
test('serializza solo su socket aperto e gestisce errori', () => {
  const sent = [];
